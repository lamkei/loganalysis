 ...
 */
public class KPIPlatForm extends Configured implements Tool {

    static class KPIPlatFormMapper extends Mapper<LongWritable, Text, Text, LongWritable> {
        ...
        private Text platFormIsMobile = new Text();
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (webLog != null && webLog.isValid()) {
                ...
                //platForm.set(userAgent.getPlatform());
                //context.write(platForm, one);
                if(userAgent.isMobile()){
                    platFormIsMobile.set(userAgent.getPlatform()+"\t"+"true");
                }
                else {
                    platFormIsMobile.set(userAgent.getPlatform()+"\t"+"false");
                }
                context.write(platFormIsMobile,one);
            }
        }
...
/*
    static class KPIPlatFormReducer extends Reducer<Text, LongWritable, Text, LongWritable> {
...
*/
    public int run(String[] allArgs) throws Exception {
        ...
        job.setJarByClass(KPIPlatForm.class);
        ...
        job.setMapperClass(KPIPlatFormMapper.class);
